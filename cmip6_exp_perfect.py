...
if not train and trend_analysis:
    ...
    dataloader_future = data_loader_future.get_dataloader()
        ...
        if trend_analysis:
            ...
            trend_bias_data = trend.calculate_future_trend_bias(statistics = ["mean"], 
                                                        ...
                                                        LOCA2 = [loca, loca_future],
                                                                delCLIMAD_BA = [transformed_x, transformed_x_future])
            ...
            pr_marginal_bias_data_future = marginal.calculate_marginal_bias(metrics = pr_metrics, 
                                                                ...
                                                                obs = y_future,
                                                                raw = x_future, 
                                                                QM = QM_debiased_future,
                                                                LOCA2 = loca_future,
                                                                delCLIMAD_BA = transformed_x_future)

            pr_marginal_bias_plot_future = marginal.plot_marginal_bias(variable = 'pr', 
                                                                bias_df = pr_marginal_bias_data,
                                                            remove_outliers = True,
                                                            outlier_threshold_statistics = 10,
                                                            metrics_title = 'Percentage bias [days]',
            ...
            spatiotemporal_dry_future = dry_days.calculate_spatiotemporal_clusters(obs = y_future,
                                                                    raw = x_future, 
                                                                    QM = QM_debiased_future,
                                                                    LOCA2 = loca_future,
                                                                delCLIMAD_BA = transformed_x_future)

            spatial_dry_future = dry_days.calculate_spatial_extent(obs = y,
                                                            raw = x_future, 
                                                            QM = QM_debiased_future,
                                                            LOCA2 = loca_future,
                                                            delCLIMAD_BA = transformed_x_future)
